...
function App() {
  ...
  return (
    <div className="container h-screen flex justify-center items-center bg-green-200">
      <div className=" text-center">
        <h1 className=" text-2xl font-medium text-blue-500 mb-4">
          My <span className=" text-green-500">URL Shortener</span>
        </h1>
        <div>
          <input
          ...
          />
          <button
            className=" bg-blue-500 font-semibold text-white px-8 py-3 ml-4 rounded-md"
            onClick={() => {
              fetchData();
            }}
          >
          ...
          <div className=" mt-5">
            ...
            <CopyToClipboard text={shortenedLink}>
              <button
                ...
                onClick={userInput ? showAlert : promtInput}
              >
